...
public class SignUpMenu extends JFrame {
    ...
    private void initComponents() {
        ...
        screenDeco9.setBackground(new Color(255, 51, 51));
        ...
        screenDeco9Layout.setHorizontalGroup(
            ...
            .addGap(0, 20, Short.MAX_VALUE)
            .addGroup(screenDeco9Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(screenDeco9Layout.createSequentialGroup()
                    .addContainerGap()
        ...
        screenDeco10.setBackground(new Color(255, 51, 51));

        screenDeco17.setBackground(new Color(255, 255, 255));
        ...
        screenDeco10Layout.setHorizontalGroup(
            ...
            .addGap(0, 20, Short.MAX_VALUE)
            .addGroup(screenDeco10Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(screenDeco10Layout.createSequentialGroup()
                    .addContainerGap()
        ...
        screenDeco11.setBackground(new Color(255, 51, 51));

        screenDeco18.setBackground(new Color(255, 255, 255));
        ...
        screenDeco11Layout.setHorizontalGroup(
            ...
            .addGap(0, 20, Short.MAX_VALUE)
            .addGroup(screenDeco11Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(screenDeco11Layout.createSequentialGroup()
                    .addContainerGap()
        ...
        screenDeco12.setBackground(new Color(255, 51, 51));

        screenDeco19.setBackground(new Color(255, 255, 255));
        ...
        screenDeco12Layout.setHorizontalGroup(
            ...
            .addGap(0, 20, Short.MAX_VALUE)
            .addGroup(screenDeco12Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(screenDeco12Layout.createSequentialGroup()
                    .addContainerGap()
        ...
        screenDeco20.setBackground(new Color(255, 255, 255));
            ...
            .addGroup(menuBordersLayout.createSequentialGroup()
                ...
                .addGroup(menuBordersLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(GroupLayout.Alignment.TRAILING, menuBordersLayout.createSequentialGroup()
                        ...
                        .addGroup(menuBordersLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            .addGroup(menuBordersLayout.createSequentialGroup()
            ...
            .addGroup(menuBordersLayout.createSequentialGroup()
                ...
                .addGroup(menuBordersLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(GroupLayout.Alignment.TRAILING, menuBordersLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(screenDeco1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                    .addComponent(screenDeco12, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
            .addGroup(menuBordersLayout.createSequentialGroup()
                .addGroup(menuBordersLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(screenDeco3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(screenDeco9, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
