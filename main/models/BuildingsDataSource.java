...
public class BuildingsDataSource {
    ...
    public BuildingsDataSource(){
        ...
        building1 = new Building("Student Center");
        ...
        building2 = new Building("CASE Building");
        ...
        building3 = new Building("SOS Building");
        ...
        building4 = new Building("SCI Building");
        building4.rooms[0][0] = roomCreator.createRoom(0,0,1,0);
        building4.rooms[1][0] = roomCreator.createRoom(0,0,1,1);
        ...
        building5 = new Building("ENG Building");
        ...
        building6 = new Building("SNA Building");
